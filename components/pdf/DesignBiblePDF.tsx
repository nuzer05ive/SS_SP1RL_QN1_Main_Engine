...
const styles = StyleSheet.create({
  page: { padding: 32, fontSize: 11, lineHeight: 1.4, fontFamily: "Courier" }, // ASCII-safe
...
const EPS =
  "0.000001293202564599051293100499461695508638360660417666";
...
export default function DesignBiblePDF({ by = "", date = "" }: { by?: string; date?: string }) {
  return (
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.p}>
          We frame a Hilbert-Pólya style operator construction where a self-adjoint kernel encodes modular
        ...
        <Text style={styles.p}>
          rho = 0.000437;  x = 7.55/(4*60) - pi/100;  epsilon_micro = | x - rho/10 |
        </Text>
